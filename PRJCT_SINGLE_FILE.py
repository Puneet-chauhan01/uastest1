...
############# detecting redhouses in burnt area###################
...
###############detecting red houses in unburnt area###################
...
################# detecting blu houses in burnt area ######################
    ...
    if len(approx1) == 3:
        ...
        if np.all(np.logical_and(centroid_pixel_value >= lwblu, centroid_pixel_value <= upblu)):
            ...
            if num_yellow_pixels > yellow_threshold:
                ...
                cv2.rectangle(result, (x_tri, y_tri), (x_tri + w_tri, y_tri + h_tri), (0, 255, 0), 2)
                bluylw_houses += 1
task2=[(bluylw_houses+redylw_houses),(redcyn_houses+blucyn_houses)]
print(task2)
task3 =[]
